...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      // 👉 Vertical nav
      const verticalNav = h(VerticalNav, { isOverlayNavActive: isOverlayNavActive.value, toggleIsOverlayNavActive, navItems: props.navItems, navMyMenuItems: props.navMyMenuItems, ...additionalVerticalNavAttrs }, {
      ...
      const tagview = h('div', { class: 'layout-tagview' }, slots.tagview?.())
      ...
      return h('div', { class: ['layout-wrapper', ...layoutClasses.value(windowWidth.value, windowScrollY.value), { 'layout-full-screen': commonStore.isFullScreen }] }, [
...
.layout-wrapper.layout-nav-type-vertical {
  ...
  .layout-tagview {
    z-index: variables.$layout-vertical-nav-tagview-z-index;
  ...
  &.layout-tagview-sticky .layout-tagview {
    position: sticky;
  }

  &.layout-tagview-sticky.layout-navbar-hidden .layout-tagview {
    inset-block-start: 0;
  }

  &.layout-tagview-sticky.layout-navbar-static .layout-tagview {
    inset-block-start: 0;
  }

  &.layout-tagview-sticky.layout-navbar-sticky .layout-tagview {
    inset-block-start: calc(variables.$layout-vertical-nav-navbar-height + 8px);
  }
