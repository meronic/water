...
export const defineThemeConfig = userConfig => {
  ...
  const localStorageIsBookmark = localStorage.getItem(`${userConfig.app.title}-isBookmark`)
  ...
  return {
    themeConfig: {
      app: {
        ...
        subtitle: userConfig.app.subtitle,
      ...
      menu: {
        isBookmarkHidden: ref(localStorageIsBookmark ? JSON.parse(localStorageIsBookmark) : userConfig.menu.userConfig),
      },
    },
    layoutConfig: {
      app: {
      ...
      menu: {
        isBookmarkHidden: userConfig.menu.userConfig,
      },
    },
  }
}
